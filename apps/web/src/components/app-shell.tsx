...
import { Home, Library, MessageCircle, CalendarClock, TrendingUp, ShieldCheck, Settings } from "lucide-react";
import { cn } from "cn";
...
export function AppShell({ user, children }: { user: UserProfile; children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-svh flex-col bg-background sm:flex-row">
      {/* Desktop sidebar */}
      <aside className="hidden w-60 shrink-0 flex-col border-r border-border px-4 py-6 sm:flex">
